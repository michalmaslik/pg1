...
char Vector3::LargestComponent(const bool absolute_value) const
{
...
Color3f Vector3::ToColor3f()
{
	return Color3f{ x, y, z };
}

Color3f Vector3::ToColor3fCompressed()
{
	Color3f c = Color3f{ x, y, z };
	c.Compress(); // linear rgb to srgb
	return c;
}

Color4f Vector3::ToColor4f()
{
	return Color4f{ x, y, z, 1.0f };
}

Color4f Vector3::ToColor4fCompressed()
{
	Color4f c = Color4f{ x, y, z, 1.0f };
	c.Compress(); // linear rgb to srgb
	return c;
}
