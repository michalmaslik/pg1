...
#define VKL_VDB_LEAF_LEVEL         3
#define VKL_VDB_LOG_RES_LEAF       3
#define VKL_VDB_STORAGE_RES_LEAF   8
#define VKL_VDB_NUM_VOXELS_LEAF    512
#define VKL_VDB_TOTAL_LOG_RES_LEAF 3
#define VKL_VDB_RES_LEAF           8
